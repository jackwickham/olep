...
public class Terminal extends AbstractActorWithTimers {
    ...
    public Terminal(int warehouseId, int districtId, Database db, MetricRegistry registry) {
        ...
        orderStatusDispatcher = new OrderStatusDispatcher(warehouseId, getSelf(), db, rand, registry);
        stockLevelDispatcher = new StockLevelDispatcher(warehouseId, districtId, getSelf(), db, rand, registry);
    }
